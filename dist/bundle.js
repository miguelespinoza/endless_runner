...
/***/ }),
/* 87 */
/* exports provided: assetImageLoad, assetSoundLoad, assetSpritesheetLoad, assetTilemapLoad, assetAtlasLoad */
/* exports used: assetSoundLoad, assetImageLoad, assetTilemapLoad, assetAtlasLoad */
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["b"] = assetImageLoad;
/* harmony export (immutable) */ __webpack_exports__["a"] = assetSoundLoad;
/* unused harmony export assetSpritesheetLoad */
/* harmony export (immutable) */ __webpack_exports__["c"] = assetTilemapLoad;
/* harmony export (immutable) */ __webpack_exports__["d"] = assetAtlasLoad;
function assetImageLoad(file) {
  return `../../assets/image/${file}`;
}

function assetSoundLoad(file) {
  return `../../assets/sound/${file}`;
}

function assetSpritesheetLoad(file) {
  return `../../assets/spritesheet/${file}`;
}
function assetTilemapLoad(file) {
  return `../../assets/tilemap/${file}`;
}

function assetAtlasLoad(file) {
  return `../../assets/atlas/${file}`;
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__states_boot__ = __webpack_require__(/*! ./states/boot */ 121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__states_load__ = __webpack_require__(/*! ./states/load */ 122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__states_menu__ = __webpack_require__(/*! ./states/menu */ 123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__states_play__ = __webpack_require__(/*! ./states/play */ 124);
...
// Initialize Phaser
var game = new __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Game(500, 340);
...
// Add all the states
game.state.add('boot', __WEBPACK_IMPORTED_MODULE_1__states_boot__["a" /* default */], false);
game.state.add('load', __WEBPACK_IMPORTED_MODULE_2__states_load__["a" /* default */], false);
game.state.add('menu', __WEBPACK_IMPORTED_MODULE_3__states_menu__["a" /* default */], false);
game.state.add('play', __WEBPACK_IMPORTED_MODULE_4__states_play__["a" /* default */], false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser__ = __webpack_require__(/*! phaser */ 40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_phaser___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_phaser__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_utils__ = __webpack_require__(/*! ../utils/utils */ 87);



/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  preload() {
    this.load.image('progressBar', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["b" /* assetImageLoad */])('progressBar.png'));
  }
  create() {
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  preload() {
    ...
    var loadingLabel = this.add.text(this.game.width / 2, 150, 'loading...', { font: '30px Arial', fill: '#ffffff' });
    ...
    this.load.audio('sounds', [__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* assetSoundLoad */])('sounds.ogg'), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["a" /* assetSoundLoad */])('sounds.mp3')]);

    this.load.image('tileset', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["b" /* assetImageLoad */])('tileset.png'));
    this.load.tilemap('map', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["c" /* assetTilemapLoad */])('map.json'), null, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Tilemap.TILED_JSON);

    this.load.atlasJSONArray('atlas', __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["d" /* assetAtlasLoad */])('atlas.png'), __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils_utils__["d" /* assetAtlasLoad */])('atlas.json'));
  }
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  create() {
    ...
    var nameLabel = this.add.text(this.game.width / 2, -50, 'Super Coin Box', { font: '50px Arial', fill: '#ffffff' });
    ...
    var scoreLabel = this.add.text(this.game.width / 2, this.game.height / 2, scoreText, { font: '25px Arial', fill: '#ffffff', align: 'center' });
    scoreLabel.anchor.setTo(0.5, 0.5);

    let startText = this.game.device.desktop ? 'press the up arrow key to start' : 'touch the screen to start';

    // Explain how to start the game
    var startLabel = this.add.text(this.game.width / 2, this.game.height - 80, startText, { font: '25px Arial', fill: '#ffffff' });
    startLabel.anchor.setTo(0.5, 0.5);

    // Create the new Phaser keyboard variable: the up arrow key
    // When pressed, call the 'start'
    var upKey = this.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.UP);
    ...
    // Tweening
    this.add.tween(nameLabel).to({ y: 80 }, 1000).easing(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Easing.Bounce.Out).start();

    this.add.tween(startLabel).to({ angle: -2 }, 500).to({ angle: 2 }, 1000).to({ angle: 0 }, 500).loop().start();
...
/* harmony default export */ __webpack_exports__["a"] = (class extends __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.State {
  create() {
    ...
    this.input.keyboard.addKeyCapture([__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.UP, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.DOWN, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.LEFT, __WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.RIGHT]);

    this.wasd = {
      up: this.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.W),
      left: this.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.A),
      right: this.input.keyboard.addKey(__WEBPACK_IMPORTED_MODULE_0_phaser___default.a.Keyboard.D)
    };
  ...
  createPointSystem() {
    ...
    // Display the score
    this.scoreLabel = this.add.text(30, 30, 'score: 0', { font: '18px Arial', fill: '#ffffff' });
  ...
  takeCoin() {
    ...
    this.add.tween(this.player.scale).to({ x: 1.3, y: 1.3 }, 100).yoyo(true).start();
  ...
  addMobileOrientationListener() {
    ...
    this.rotateLabel = this.game.add.text(this.game.width / 2, this.game.height / 2, '', { font: '30px Arial', fill: '#fff', backgroundColor: '#000' });
...
$export($export.S + $export.F * !__webpack_require__(/*! ./_descriptors */ 6), 'Object', {defineProperties: __webpack_require__(/*! ./_object-dps */ 102)});
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! ./../webpack/buildin/global.js */ 49), __webpack_require__(/*! ./../process/browser.js */ 116)))
...
module.exports = __webpack_require__(/*! /Users/miguele/Games/endless_runner/src/main.js */117);
